...
def list_products():
    """
    Lists all Products
    This endpoint will list all Products in the database
    """
...
def get_products(product_id):
    """
    Reads a Product
    This endpoint will read a Product based the provided id
    """
...
def delete_products(product_id):
    """
    Deletes a Product
    This endpoint will delete a Product based the provided id
    """
